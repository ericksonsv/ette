...
<body class="text-gray-700 font-nunito">
    ...
    <table class="w-full mb-6">
        <tr>
            <td>
                <p class="text-xl text-center uppercase">{{ trans('Order Service Information') }}</p>
            </td>
        </tr>
    </table>
        ...
        <tbody>
            ...
            @if ($service->flight && $service->flight_time)
                ...
                <tr>
                    ...
                    <td class="px-2">{{ displayTime($service->flight_time) }}</td>
                </tr>
            @endif
        </tbody>
    </table>
    ...
    <table class="w-full text-sm">
        <tbody>
            <tr>
                ...
                <td class="border px-2 py-1">{{ displayTime($service->time) }}</td>
            </tr>
            <tr>
